...
Check https://github.com/elupus/esphome-nibe and https://www.home-assistant.io/integrations/nibe_heatpump
I did not like the +700 unused entities that the integrated Nibe produces. 

Exported the modbus list from my heatpump at set the sensors i am interested in manually, I.E, i copied mkaiser´s modbus_sungrow.yaml and replaced the solar sensors with Nibe sensors from the paramater list.
